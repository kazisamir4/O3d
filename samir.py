...
##    ## ##     ## ##     ##  ##  ##    ##  
 ...
                            \x1b[1;92m║➣Group     : samir Termux commmand 2022 ║ 
 ...
             pass 
         if len(cp) != 0: 
             print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92msamir_OK.txt' % (H, P, str(len(ok)))) 
             print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91msamir_CP.txt' % (H, P, str(len(cp)))) 
